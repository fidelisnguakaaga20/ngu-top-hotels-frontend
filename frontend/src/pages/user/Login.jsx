...
//            className='w-full mt-5 py-3 bg-primary hover:bg-indigo-500 text-white font-medium rounded-md'>Login</button>
//         </form>
...
const Login = () => {
  ...
  return (
    <div className='max-w-sm bg-white mx-auto p-8 mt-36'>
      ...
      {/* ❌ missing space between props: onSubmit and className */}
      {/* ✅ add a space so JSX parses attributes correctly */}
      <form onSubmit={handleLogin} className='space-y-5 max-w-sm mx-auto pt-8'>  {/* FIX: space before className */}
        <input
          type="email"
          value={email}
          placeholder='Email'
