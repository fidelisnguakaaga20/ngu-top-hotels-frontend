...
const SingleBlogCard = ({ blog }) => {
    ...
    const parsed = data ? editorJSHTML.parse(data) : [];                          
    const htmlContent = Array.isArray(parsed) ? parsed.join('')                   
    : (parsed?.html ?? parsed ?? '');
    ...
    <>
        <div className='bg-white p-8'>
            ...
            <div>
                ...
                {/* Todo: we need to change author */}
                <p className='mt-6'>{formatDate(createdAt)} by <span className='text-blue-400 cursor-pointer'>Admin 1</span></p>
            </div>
            <div>
